...
public class burcroffNodeClass {

	burcroffNodeClass next;//Creating a reference to next.
	burcroffNodeClass previous;//Creating a reference to previous.
	...
	//public burcroffNodeClass(Object data, burcroffNodeClass next, burcroffNodeClass previous) 
	//{
	...
	//}
	public burcroffNodeClass(int passedValue) 
	{
		//next = this.next;//Setting the reference of next to this next.
		//data =  this.data;//Setting the reference of data to this data.
		//previous = this.previous;//Setting the reference to this previous.
	...
	public void setPrevious(burcroffNodeClass previous) 
	{
	...
	public burcroffNodeClass getPrevious() 
	{
	...
	public burcroffNodeClass getNext() 
	{
	...
	public void setNext(burcroffNodeClass nextValue) 
	{
